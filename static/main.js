...
window.onload=function(){
	...
	if (IsLoggedIn() == false) {
		...
		document.getElementById("touserme").addEventListener("click", loadUser);
...
if (IsLoggedIn() != true){
	...
	document.getElementById("toor").innerHTML = `<nav class="links"><a href="/" id="home"><strong>Home</strong></a><a id='toupload'><strong>Upload</strong></a><a id='toevents'><strong>Events</strong></a><a id='toplaces'><strong>Places</strong></a><a id='totranslate'><strong>Translate</strong></a><a id='touserme'><strong>Me</strong></a><a id="logout"><strong>Logout</strong></a></nav><section class="about" id="main"><h1>Aespa</h1><p id='demo'>What do you believe in ..?</p></section>${footer}`;
...
function loadUser() {
	loadScript('/static/dynamic/user.js',function(){
		console.log('done loading');
		createProfilePage();
		ChangeLoc();
	});
