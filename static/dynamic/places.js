...
document.getElementById("inptfile").addEventListener("change", myPlaceFunction);
}
...
function renderPlace(obj) {
	let html = `<section id="places">gfdgbfh</section>`;
	document.getElementById("main").innerHTML = html;
	document.getElementById("places").innerHTML = "<p>"+"<br>"+obj.nameofplace+"<br>"+obj.address+"<br>"+obj.category+"<br>"+obj.closingtime+"<br>"+obj.openingtime+"<br>"+obj.phonenumber+"<br>"+obj.instagaram+"<br>"+obj.website+"<br>"+obj.facilities+"<br>"+obj.about+"<br>"+obj.paymentmethod+"<br>"+obj.keyword+"<br><span id='pagelink'></span></p>";
	var gl = document.getElementById('pagelink');//placelink?
