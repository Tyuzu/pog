...
function togglePhotoModal() {
	...
	document.getElementById("pics").innerHTML = `<form class="upform" enctype="multipart/form-data"  id="new_document_attachment">
...
function toggleVideoModal() {
	...
	document.getElementById("vids").innerHTML = `<form class="upform" enctype="multipart/form-data">
